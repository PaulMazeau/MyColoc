...
export default function LoginScreen({navigation}: Props) {
  ...
  return (
    <View style={styles.container}>
      ...
      {loading ? <ActivityIndicator size='large'/>:<CustomButton title="Se connecter" onPress={() => {Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);signIn()}} />}
    </View>
  );
}
