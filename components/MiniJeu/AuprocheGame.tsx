...
export default function AuprocheGame() {
    ...
    const [currPointsGG, setCurrPointsGG] = useState(0)
    ...
    if(currQuestion<numberOfQuestions-1){
        ...
        return(
            <Answer reponse = {questions[currQuestion].reponse} timeLeft={seconds} goodAnswer={goodAnswer} lastQuestion={false} points={currPointsGG}/>
        )}
    }if(currQuestion == numberOfQuestions-1){
        if(seconds>5){
            return(
            ...
            return(
                <Answer reponse = {questions[currQuestion].reponse}  points={currPointsGG} timeLeft={seconds} goodAnswer={goodAnswer} lastQuestion={true}/>
            )
    }}
