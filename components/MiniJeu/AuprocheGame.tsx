...
export default function AuprocheGame() {
    ...
    const [currQuestion, setCurrQuestion] = useState(-1) // pq -1 ? car lorsque seconde =30 on incrémente de 1, donc dès le début du timer currQuestion vaut 0 (ce qu'on veut). On pourrait start à 0 et update à 0sec MAIS cela laisse la seconde entre 0 et le nouveau 30 dans l'état ou currQuestion vaut 1 de plus que ce qu'elle devrait à cet instant.
